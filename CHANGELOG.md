...
- Added automatic multi-monitor detection on Windows and Linux.
- Added a monitor selector to the first-run setup wizard.
- Added a monitor selector to Display & Design settings.
- The startup/loading screen opens on the selected monitor.
- The main Auralyn Click window opens and reopens on the selected monitor.
- Windows Setup detects the number of connected monitors and can save Monitor 1, 2, 3, etc. as the initial choice.
- GitHub release workflow now keeps normal source code in the repository while release assets focus on Windows and Linux builds.

## 2.4.4 — release cleanup and documentation
