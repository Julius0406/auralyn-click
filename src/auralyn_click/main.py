...
from .ipc import IPCBridge, IPCServer, SOCKET_PATH, acquire_single_instance, send_command
...
class AuralynWindow(QMainWindow):
    ...
    def restart_for_language(self) -> None:
        ...
        subprocess.Popen(
            ["bash", "-lc", f"sleep 0.55; {python} -m auralyn_click"],
    ...
    def closeEvent(self, event) -> None:
        ...
        try:
            fcntl.flock(self.lock_fd.fileno(), fcntl.LOCK_UN); self.lock_fd.close()
        except Exception:
            pass
        try:
